...
/**
 * 라우트경로 : /admin/shop/payment
 */
use Jiny\WireTable\Http\Controllers\WireTablePopupForms;
class AdminShopPaymentController extends WireTablePopupForms
{
    public function __construct()
    {
        ...
        $this->actions['title'] = "관리자 : 결제 수단 관리";
        $this->actions['subtitle'] = "결제 수단 관리 페이지입니다.";
